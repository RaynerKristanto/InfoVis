...
function updateBars(house) {
    ...
    var houseChars = characters.filter(function(char) {
      if (house == "top") {
        return char["power_ranking"] > 0;
      }
      return char["house"] == house;
    });


    houseChars.sort(function(char1, char2) {
      return char2.probability_of_survival - char1.probability_of_survival;
    })
    renderBars(houseChars);
